...
void primes(int n){
   0:	85aa                	mv	a1,a0
	m = 0;
   2:	00001797          	auipc	a5,0x1
   6:	8c07af23          	sw	zero,-1826(a5) # 8e0 <m>
    for(int i = 2; i < n; i++){
   a:	4789                	li	a5,2
   c:	4501                	li	a0,0
   e:	4601                	li	a2,0
  10:	4709                	li	a4,2
  12:	4685                	li	a3,1
  14:	02b7d563          	bge	a5,a1,3e <primes+0x3e>
  18:	0017079b          	addiw	a5,a4,1
  1c:	0007871b          	sext.w	a4,a5
  20:	00e58863          	beq	a1,a4,30 <primes+0x30>
        if(n/i == 0){
  24:	02f5c7bb          	divw	a5,a1,a5
  28:	fbe5                	bnez	a5,18 <primes+0x18>
  2a:	8536                	mv	a0,a3
            m = 1;
  2c:	8636                	mv	a2,a3
  2e:	b7ed                	j	18 <primes+0x18>
  30:	c519                	beqz	a0,3e <primes+0x3e>
  32:	00001797          	auipc	a5,0x1
  36:	8ac7a723          	sw	a2,-1874(a5) # 8e0 <m>
        }
    }
	if(m==0){
  3a:	c211                	beqz	a2,3e <primes+0x3e>
  3c:	8082                	ret
void primes(int n){
  ...
  4a:	86a50513          	addi	a0,a0,-1942 # 8b0 <malloc+0xe8>
  4e:	00000097          	auipc	ra,0x0
  52:	6bc080e7          	jalr	1724(ra) # 70a <printf>
	}
}
  56:	60a2                	ld	ra,8(sp)
  58:	6402                	ld	s0,0(sp)
...
int main(){
  ...
  66:	1800                	addi	s0,sp,48
	...
	int p[2], number;
    pipe(p);
  68:	fd840513          	addi	a0,s0,-40
  6c:	00000097          	auipc	ra,0x0
  70:	336080e7          	jalr	822(ra) # 3a2 <pipe>

	if(fork()==0){
  74:	00000097          	auipc	ra,0x0
  78:	316080e7          	jalr	790(ra) # 38a <fork>
  7c:	e929                	bnez	a0,ce <main+0x70>
		close(p[0]);
  7e:	fd842503          	lw	a0,-40(s0)
  82:	00000097          	auipc	ra,0x0
  86:	338080e7          	jalr	824(ra) # 3ba <close>
		for(int i = 2; i <= 35; i++){
  8a:	4789                	li	a5,2
  8c:	fcf42823          	sw	a5,-48(s0)
  90:	02300493          	li	s1,35
			write( p[1], &i, 4 );
  94:	4611                	li	a2,4
  96:	fd040593          	addi	a1,s0,-48
  9a:	fdc42503          	lw	a0,-36(s0)
  9e:	00000097          	auipc	ra,0x0
  a2:	314080e7          	jalr	788(ra) # 3b2 <write>
		for(int i = 2; i <= 35; i++){
  a6:	fd042783          	lw	a5,-48(s0)
  aa:	2785                	addiw	a5,a5,1
  ac:	0007871b          	sext.w	a4,a5
  b0:	fcf42823          	sw	a5,-48(s0)
  b4:	fee4d0e3          	bge	s1,a4,94 <main+0x36>
		}
		close(p[1]);
  b8:	fdc42503          	lw	a0,-36(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	2fe080e7          	jalr	766(ra) # 3ba <close>
		exit(0);
  c4:	4501                	li	a0,0
  c6:	00000097          	auipc	ra,0x0
  ca:	2cc080e7          	jalr	716(ra) # 392 <exit>
	}
	
	close(p[1]);	
  ce:	fdc42503          	lw	a0,-36(s0)
  d2:	00000097          	auipc	ra,0x0
  d6:	2e8080e7          	jalr	744(ra) # 3ba <close>
	while(read(p[0], &number, 4)){
  da:	4611                	li	a2,4
  dc:	fd440593          	addi	a1,s0,-44
  e0:	fd842503          	lw	a0,-40(s0)
  e4:	00000097          	auipc	ra,0x0
  e8:	2c6080e7          	jalr	710(ra) # 3aa <read>
  ec:	c901                	beqz	a0,fc <main+0x9e>
		primes(number);
  ee:	fd442503          	lw	a0,-44(s0)
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <primes>
  fa:	b7c5                	j	da <main+0x7c>
	}
	close(p[0]);
  fc:	fd842503          	lw	a0,-40(s0)
 100:	00000097          	auipc	ra,0x0
 104:	2ba080e7          	jalr	698(ra) # 3ba <close>
	wait(0);
 108:	4501                	li	a0,0
 10a:	00000097          	auipc	ra,0x0
 10e:	290080e7          	jalr	656(ra) # 39a <wait>
	exit(0);
 112:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	45250513          	addi	a0,a0,1106 # 8c8 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 546:	386b8b93          	addi	s7,s7,902 # 8c8 <digits>
 ...
 686:	23e90913          	addi	s2,s2,574 # 8c0 <malloc+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74e:	19e7b783          	ld	a5,414(a5) # 8e8 <freep>
 ...
 77c:	00e6ea63          	bltu	a3,a4,790 <free+0x50>
{
 ...
 7be:	12f73723          	sd	a5,302(a4) # 8e8 <freep>
}
 7c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f0:	0fc53503          	ld	a0,252(a0) # 8e8 <freep>
 ...
 818:	0d490913          	addi	s2,s2,212 # 8e8 <freep>
  if(p == (char*)-1)
 81c:	5afd                	li	s5,-1
 81e:	a88d                	j	890 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 820:	00000797          	auipc	a5,0x0
 824:	0d078793          	addi	a5,a5,208 # 8f0 <base>
 828:	00000717          	auipc	a4,0x0
 82c:	0cf73023          	sd	a5,192(a4) # 8e8 <freep>
 830:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 852:	08a73d23          	sd	a0,154(a4) # 8e8 <freep>
      return (void*)(p + 1);
